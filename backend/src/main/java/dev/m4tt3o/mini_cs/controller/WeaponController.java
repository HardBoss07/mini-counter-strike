...
import dev.m4tt3o.mini_cs.dto.WeaponArchetype;
import dev.m4tt3o.mini_cs.entity.WeaponTemplate;
import dev.m4tt3o.mini_cs.repository.WeaponTemplateRepository;
...
public class WeaponController {
    ...
    public ResponseEntity<List<WeaponArchetype>> getAllWeapons() {
        List<WeaponArchetype> weapons = weaponTemplateRepository.findAll()
                .stream()
