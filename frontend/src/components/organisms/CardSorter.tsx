...
export const CardSorter: React.FC<CardSorterProps> = ({ items, children }) => {
    ...
    const processedItems = useMemo(() => {
        ...
        result.sort((a, b) => {
            switch (sortBy) {
                case 'cost-asc': return a.energyCost - b.energyCost;
                case 'cost-desc': return b.energyCost - a.energyCost;
                case 'dmg-desc': return b.damage - a.damage;
                case 'name':
    ...
    return (
        <div className="space-y-6">
            ...
            {processedItems.length === 0 ? (
                <div className="text-center text-gray-500 py-12 text-sm">No weapons match your filters.</div>
            ) : (
