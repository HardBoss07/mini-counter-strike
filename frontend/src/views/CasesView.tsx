...
const CasesView: React.FC = () => {
  ...
  const handleOpen = async () => {
    ...
    try {
      ...
      setUnlocked({ id: 0, name: result.weaponName, imageUrl: result.imageUrl, description: result.rarity } as any);
    } finally {
      setIsOpening(false);
    }
  };
  ...
  return (
    <div className="flex flex-col items-center gap-12 py-16">
      <h2 className="text-4xl font-black uppercase tracking-widest">Cases Available: {profile.caseCount}</h2>
